...
public class Float_LiteralImpl extends MinimalEObjectImpl.Container implements Float_Literal
{
  ...
  {
    return MyDslPackage.Literals.FLOAT_LITERAL;
  }
  ...
  public void setDecimalDigits1(int newDecimalDigits1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.FLOAT_LITERAL__DECIMAL_DIGITS1, oldDecimalDigits1, decimalDigits1));
  }
  ...
  public void setDecimalDigits2(int newDecimalDigits2)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.FLOAT_LITERAL__DECIMAL_DIGITS2, oldDecimalDigits2, decimalDigits2));
  }
  ...
  public void setExp(String newExp)
  {
    ...
    exp = newExp;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.FLOAT_LITERAL__EXP, oldExp, exp));
  }
  ...
  public void setFloatTypeSufix(String newFloatTypeSufix)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.FLOAT_LITERAL__FLOAT_TYPE_SUFIX, oldFloatTypeSufix, floatTypeSufix));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.FLOAT_LITERAL__DECIMAL_DIGITS1:
        return getDecimalDigits1();
      case MyDslPackage.FLOAT_LITERAL__DECIMAL_DIGITS2:
        return getDecimalDigits2();
      case MyDslPackage.FLOAT_LITERAL__EXP:
        return getExp();
      case MyDslPackage.FLOAT_LITERAL__FLOAT_TYPE_SUFIX:
