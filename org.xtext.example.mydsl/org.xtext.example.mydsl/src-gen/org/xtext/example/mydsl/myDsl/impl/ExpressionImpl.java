 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ExpressionImpl#getNumericExpression3 <em>Numeric Expression3</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ExpressionImpl#getAux <em>Aux</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ExpressionImpl#getLogicalExpression <em>Logical Expression</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ExpressionImpl#getBitExpression <em>Bit Expression</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ExpressionImpl#getCastExpression <em>Cast Expression</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ExpressionImpl#getCreatingExpression <em>Creating Expression</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ExpressionImpl#getLiteralExpression <em>Literal Expression</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ExpressionImpl#getNull <em>Null</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ExpressionImpl#getSuper <em>Super</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ExpressionImpl#getThis <em>This</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ExpressionImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpressionImpl extends MinimalEObjectImpl.Container implements Expression
{
  ...
  public NotificationChain basicSetNumericExpression3(Numeric_Expression_NR newNumericExpression3, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__NUMERIC_EXPRESSION3, oldNumericExpression3, newNumericExpression3);
  ...
  public void setNumericExpression3(Numeric_Expression_NR newNumericExpression3)
  {
    if (newNumericExpression3 != numericExpression3)
    {
      ...
      if (numericExpression3 != null)
        msgs = ((InternalEObject)numericExpression3).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION__NUMERIC_EXPRESSION3, null, msgs);
      if (newNumericExpression3 != null)
        msgs = ((InternalEObject)newNumericExpression3).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION__NUMERIC_EXPRESSION3, null, msgs);
      msgs = basicSetNumericExpression3(newNumericExpression3, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__NUMERIC_EXPRESSION3, newNumericExpression3, newNumericExpression3));
  }
  ...
  public NotificationChain basicSetAux(Expression_aux newAux, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__AUX, oldAux, newAux);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setAux(Expression_aux newAux)
  {
    if (newAux != aux)
    {
      NotificationChain msgs = null;
      if (aux != null)
        msgs = ((InternalEObject)aux).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION__AUX, null, msgs);
      if (newAux != null)
        msgs = ((InternalEObject)newAux).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION__AUX, null, msgs);
      msgs = basicSetAux(newAux, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__AUX, newAux, newAux));
  }
  ...
  public NotificationChain basicSetLogicalExpression(Logical_Expression_NR newLogicalExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__LOGICAL_EXPRESSION, oldLogicalExpression, newLogicalExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setLogicalExpression(Logical_Expression_NR newLogicalExpression)
  {
    if (newLogicalExpression != logicalExpression)
    {
      ...
      if (logicalExpression != null)
        msgs = ((InternalEObject)logicalExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION__LOGICAL_EXPRESSION, null, msgs);
      if (newLogicalExpression != null)
        msgs = ((InternalEObject)newLogicalExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION__LOGICAL_EXPRESSION, null, msgs);
      msgs = basicSetLogicalExpression(newLogicalExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__LOGICAL_EXPRESSION, newLogicalExpression, newLogicalExpression));
  }
  ...
  public NotificationChain basicSetBitExpression(Bit_Expression_NR newBitExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__BIT_EXPRESSION, oldBitExpression, newBitExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setBitExpression(Bit_Expression_NR newBitExpression)
  {
    if (newBitExpression != bitExpression)
    {
      ...
      if (bitExpression != null)
        msgs = ((InternalEObject)bitExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION__BIT_EXPRESSION, null, msgs);
      if (newBitExpression != null)
        msgs = ((InternalEObject)newBitExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION__BIT_EXPRESSION, null, msgs);
      msgs = basicSetBitExpression(newBitExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__BIT_EXPRESSION, newBitExpression, newBitExpression));
  }
  ...
  public NotificationChain basicSetCastExpression(Cast_Expression newCastExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__CAST_EXPRESSION, oldCastExpression, newCastExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setCastExpression(Cast_Expression newCastExpression)
  {
    if (newCastExpression != castExpression)
    {
      ...
      if (castExpression != null)
        msgs = ((InternalEObject)castExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION__CAST_EXPRESSION, null, msgs);
      if (newCastExpression != null)
        msgs = ((InternalEObject)newCastExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION__CAST_EXPRESSION, null, msgs);
      msgs = basicSetCastExpression(newCastExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__CAST_EXPRESSION, newCastExpression, newCastExpression));
  }
  ...
  public NotificationChain basicSetCreatingExpression(Creating_Expression newCreatingExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__CREATING_EXPRESSION, oldCreatingExpression, newCreatingExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setCreatingExpression(Creating_Expression newCreatingExpression)
  {
    if (newCreatingExpression != creatingExpression)
    {
      ...
      if (creatingExpression != null)
        msgs = ((InternalEObject)creatingExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION__CREATING_EXPRESSION, null, msgs);
      if (newCreatingExpression != null)
        msgs = ((InternalEObject)newCreatingExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION__CREATING_EXPRESSION, null, msgs);
      msgs = basicSetCreatingExpression(newCreatingExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__CREATING_EXPRESSION, newCreatingExpression, newCreatingExpression));
  }
  ...
  public NotificationChain basicSetLiteralExpression(Literal_Expression newLiteralExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__LITERAL_EXPRESSION, oldLiteralExpression, newLiteralExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setLiteralExpression(Literal_Expression newLiteralExpression)
  {
    if (newLiteralExpression != literalExpression)
    {
      ...
      if (literalExpression != null)
        msgs = ((InternalEObject)literalExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION__LITERAL_EXPRESSION, null, msgs);
      if (newLiteralExpression != null)
        msgs = ((InternalEObject)newLiteralExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXPRESSION__LITERAL_EXPRESSION, null, msgs);
      msgs = basicSetLiteralExpression(newLiteralExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__LITERAL_EXPRESSION, newLiteralExpression, newLiteralExpression));
  }
  ...
  public void setNull(String newNull)
  {
    ...
    null_ = newNull;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__NULL, oldNull, null_));
  }
  ...
  public void setSuper(String newSuper)
  {
    ...
    super_ = newSuper;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__SUPER, oldSuper, super_));
  }
  ...
  public void setThis(String newThis)
  {
    ...
    this_ = newThis;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXPRESSION__THIS, oldThis, this_));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.EXPRESSION__NUMERIC_EXPRESSION3:
        return basicSetNumericExpression3(null, msgs);
      case MyDslPackage.EXPRESSION__AUX:
        return basicSetAux(null, msgs);
      case MyDslPackage.EXPRESSION__LOGICAL_EXPRESSION:
        return basicSetLogicalExpression(null, msgs);
      case MyDslPackage.EXPRESSION__BIT_EXPRESSION:
        return basicSetBitExpression(null, msgs);
      case MyDslPackage.EXPRESSION__CAST_EXPRESSION:
        return basicSetCastExpression(null, msgs);
      case MyDslPackage.EXPRESSION__CREATING_EXPRESSION:
        return basicSetCreatingExpression(null, msgs);
      case MyDslPackage.EXPRESSION__LITERAL_EXPRESSION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.EXPRESSION__NULL:
        return getNull();
      case MyDslPackage.EXPRESSION__SUPER:
        return getSuper();
      case MyDslPackage.EXPRESSION__THIS:
        return getThis();
