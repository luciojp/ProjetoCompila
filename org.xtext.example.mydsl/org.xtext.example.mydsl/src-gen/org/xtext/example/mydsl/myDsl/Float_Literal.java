 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.Float_Literal#getDecimalDigits1 <em>Decimal Digits1</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.Float_Literal#getDecimalDigits2 <em>Decimal Digits2</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.Float_Literal#getExp <em>Exp</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.Float_Literal#getFloatTypeSufix <em>Float Type Sufix</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getFloat_Literal()
 * @model
 * @generated
 */
public interface Float_Literal extends EObject
{
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getFloat_Literal_DecimalDigits1()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.Float_Literal#getDecimalDigits1 <em>Decimal Digits1</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getFloat_Literal_DecimalDigits2()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.Float_Literal#getDecimalDigits2 <em>Decimal Digits2</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setExp(String)
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getFloat_Literal_Exp()
   * @model
   * @generated
   */
  String getExp();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.Float_Literal#getExp <em>Exp</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getFloat_Literal_FloatTypeSufix()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.Float_Literal#getFloatTypeSufix <em>Float Type Sufix</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
